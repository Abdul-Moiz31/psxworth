...
function TooltipOverlay() {
  ...
  const [arrowElement, setArrowElementState] = React.useState<SVGSVGElement | null>(null);
  ...
  const middleware = React.useMemo(
    ...
    [arrowElement, rendered.data?.alignOffset, rendered.data?.sideOffset]
  );
  ...
  const setFloatingElement = React.useCallback(
    ...
    <AnimatePresence mode="wait">
      {rendered.data && ready && (
        <TooltipPortal>
          ...
          >
            <FloatingProvider value={{ context, arrowRef, setArrowElement }}>
