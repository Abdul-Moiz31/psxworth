...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div
      className={cn(
        "flex h-10 w-full rounded-md border border-border bg-background px-3 text-sm shadow-sm transition-colors",
        "outline outline-1 outline-offset-0 outline-muted-foreground/20",
    ...
    >
      <input
        ...
        placeholder="DD"
      />
      <span className="opacity-40 -mx-px leading-none flex items-center">/</span>
      <input
        type="text"
        ref={monthRef}
        max={12}
