...
const inputVariants = cva(
  "block w-full text-sm text-foreground bg-transparent appearance-none focus:outline-none focus:ring-0 peer disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
