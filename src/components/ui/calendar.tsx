...
function Calendar({
  ...
  const _dayButtonClassName = cn(
    ...
    "size-8 rounded-md p-0 font-normal transition-none aria-selected:opacity-100 hover:bg-primary hover:text-primary-foreground",
  ...
  const _todayClassName = cn("", props.todayClassName);
...
function Nav({
  ...
  return (
    <nav className={cn("flex items-center", className)}>
      <Button
        variant="outline"
        className="absolute left-0 h-7 w-7 bg-transparent p-0 opacity-80 hover:opacity-100 hover:bg-primary hover:text-primary-foreground"
        type="button"
      ...
      <Button
        variant="outline"
        className="absolute right-0 h-7 w-7 bg-transparent p-0 opacity-80 hover:opacity-100 hover:bg-primary hover:text-primary-foreground"
        type="button"
...
function CaptionLabel({
  ...
  return (
    <Button
      className="h-7 w-full truncate text-sm font-medium hover:bg-primary hover:text-primary-foreground"
      variant="ghost"
      size="sm"
    ...
    <div className={cn("grid grid-cols-4 gap-y-2", className)} {...props}>
      {Array.from({ length: displayYears.to - displayYears.from + 1 }, (_, i) => {
        ...
        return (
          <Button
            key={i}
            className="h-7 w-full text-sm font-normal text-foreground hover:bg-primary hover:text-primary-foreground"
            variant="ghost"
            onClick={() => {
              setNavView("days");
